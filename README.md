<h1 align="center">Hi, I'm yeBlue</h1>

<p align="center">
  <strong>Senior iOS Engineer · Open Source Creator</strong>
</p>

<p align="center">
  专注 Apple 平台开发，深耕 iOS 超过 10 年。<br/>
  持续构建稳定、易用、可复用的开源组件，关注 UI 基础能力、文本渲染、分页交互与音视频相关技术。
</p>
...
- Apple 平台开发者，长期聚焦 **iOS / macOS / tvOS**
- 擅长 **Objective-C / Swift** 工程实践与老项目演进
- 在 **UI 组件化、富文本渲染、分页与轮播** 上有持续开源积累
- 偏好用简洁、稳定、可维护的方式解决真实问题
...
<p>
  ...
  <img src="https://img.shields.io/badge/tvOS-000000?style=flat-square&logo=apple&logoColor=white" />
...
- GitHub: [@12207480](https://github.com/12207480)
